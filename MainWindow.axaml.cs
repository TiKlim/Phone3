...
namespace Phone3
{
    public partial class MainWindow : Window
    {
        ...
        private void Butoon_Click(object? sender, RoutedEventArgs e)
        {
            ...
            if (a169.IsChecked == true && a170.IsChecked == true && a176.IsChecked == true && a183.IsChecked == true && a190.IsChecked == true && a191.IsChecked == true && a192.IsChecked == true && a182.IsChecked == true && a181.IsChecked == true && a187.IsChecked == true && a186.IsChecked == true)
            {
                message.Text += "7";
            }
